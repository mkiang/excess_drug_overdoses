---
title: "Tables S2. Excess deaths by substance and educational attainment"
author: "Mathew Kiang"
date: "2/9/2022"
output: 
  html_document:
...
table_2 %>%
    ...
    kableExtra::pack_rows("All 25 and older", 1, 11) %>%
    kableExtra::pack_rows("Less than High School", 12, 19) %>%
    kableExtra::pack_rows("High school diploma / GED", 20, 30) %>%
    kableExtra::pack_rows("Less than BA/BS", 31, 41) %>%
    kableExtra::pack_rows("Bachelors", 42, 45) %>%
    kableExtra::pack_rows("Graduate", 46, 47)
```
