...
## Data ----
reshaped_pop <- readRDS(here("data", "pop_by_race_age_extrapolated.RDS"))
cume_excess_deaths <- readRDS(here("data", "supp_cume_excess_deaths_age.RDS")) %>%
    filter(
...
ggsave(
    here("plots", "figS05_cume_excess_deaths_per_100k_by_age.pdf"),
    per_capita_cume,
    width = 8.5,
    height = 6.5,
    scale = .9,
...
ggsave(
    here("plots", "figS05_cume_excess_deaths_per_100k_by_age.jpg"),
    per_capita_cume,
    width = 8.5,
    height = 6.5,
    scale = .9,
...
write_csv(cume_excess_deaths %>% 
              select(death_cat, 
                     ...
                     upper,
                     lower), 
          here("output", "figS05_data_excess_by_age.csv"))
