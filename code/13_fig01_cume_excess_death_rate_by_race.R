...
## Save ----
ggsave(
    here("plots", "fig01_cume_excess_deaths_per_100k_by_race.pdf"),
    per_capita_cume,
    width = 6.5,
    height = 4,
    scale = 1.1,
...
ggsave(
    here("plots", "fig01_cume_excess_deaths_per_100k_by_race.jpg"),
    per_capita_cume,
    width = 6.5,
    height = 4,
    scale = 1.1,
...
write_csv(cume_excess_deaths %>% 
              select(death_cat, 
                     ...
                     upper,
                     lower), 
          here("output", "fig01_data_excess_by_race.csv"))
